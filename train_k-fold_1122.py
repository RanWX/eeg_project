...
if __name__ == '__main__':
    ...
    # time_point = 10
    k = 10
    for t in range(1, 241, 1):
        print("*********** timepoint: {} *******".format(str(t)))
        result_list = []
        for i in range(k):
            train_data_list, val_data_list, test_data_list = data_process.split_specify_time_dataset_by_proportion_1122(
                t,
                src_path="",
                seed=42,
                **proportion)
            ...
            save_str = train.train_model(t, train_data_list,
                                         val_data_list,
                                         test_data_list, i,
                                         "leave_one_session_out")
            result_list.append(save_str)

        with open("result_1122_10_fold/result_1122_10_fold_{}.txt".format(str(t * 2)), "w") as f:
            f.write("\n".join(result_list))
