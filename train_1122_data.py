...
class train():
    ...
    def train_model(self, time_point, train_data_list, val_data_list, test_data_list, cv_type):
        # TODO: no cuda
...
if __name__ == '__main__':
    ...
    train_data_list, val_data_list, test_data_list = data_process.split_specify_time_dataset_by_proportion_1122(
        ...
        seed=42,
        **proportion)
    train.train_model(time_point, train_data_list, val_data_list, test_data_list, "leave_one_session_out")
