...
class train():
    ...
    def set_parameter(self, model, number_class, sampling_rate, random_seed, learning_rate, epoch, batch_size,
                      dropout_1, dropout_2, patient, Lambda):
        '''
    ...
    def train_model(self, train_data_list, val_data_list, test_data_list, cv_type):
        ...
        # build the model
        model = EEGNet(self.num_class, 62, self.dropout_1, self.dropout_2, 2000, self.sampling_rate)
...
if __name__ == '__main__':
    ...
    train = train()
    # set parameters
    train.set_parameter(model='EEGNet',
                        number_class=2,
                        sampling_rate=1000,
                        random_seed=42,
                        learning_rate=0.001,
                        ...
                        patient=4,
                        Lambda=0.000001)
    train_data_list, val_data_list, test_data_list = data_process.split_specify_time_dataset_by_proportion("*", 10,
                                                                                                           src_path="",
                                                                                                           seed=0,
                                                                                                           **proportion)
